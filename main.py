...
logo_design_1 = Fore.YELLOW + '''
                      ,____
                      |---.\\
              ___     |    `     < Android-Hackit />
             / .-\  ./=)         << Coded by Adinath N ( AKA Hyper-Programmer )
            |  |"|_/\/|          
            ;  |-;| /_|           Boo, I'm Hacker Bitch :|
           / \_| |/ \ |
          /      \/\( |
          |   /  |` ) |
          /   \ _/    |
...
logo_design_2 = Fore.BLUE + '''
    .o oOOOOOOOo                                            OOOo
    Ob.OOOOOOOo  OOOo.      oOOo.                      .adOOOOOOO
    OboO"""""""""""".OOo. .oOOOOOo.    OOOo.oOOOOOo.."""""""""'OO             < Android-Hackit />
    OOP.oOOOOOOOOOOO "POOOOOOOOOOOo.   `"OOOOOOOOOP,OOOOOOOOOOOB'             << Coded by Adinath N ( AKA Hyper-Programmer )
    `O'OOOO'     `OOOOo"OOOOOOOOOOO` .adOOOOOOOOO"oOOO'    `OOOOo             <<< I'm Hacker Bitch :|
...
{0}[{1}1{0}] {2}Show Connected Devices              {0}[{1}11{0}] {2}Uninstall an app                   {0}[{1}21{0}]{2} NetStat                  
{0}[{1}2{0}] {2}Disconect all devices               {0}[{1}12{0}] {2}Show real time log of device       {0}[{1}22{0}]{2} Turn WiFi On/Off         
{0}[{1}3{0}] {2}Connect a new phone                 {0}[{1}13{0}] {2}Dump System Info                   {0}[{1}23{0}]{2} Remove Password          
{0}[{1}4{0}] {2}Access Shell on a phone             {0}[{1}14{0}] {2}List all apps on a phone           {0}[{1}24{0}]{2} Use Keycode              
{0}[{1}5{0}] {2}Install an apk on a phone           {0}[{1}15{0}] {2}Run an                             {0}[{1}25{0}]{2} Get Current Activity     
{0}[{1}6{0}] {2}Screen record a phone               {0}[{1}16{0}]{2} Port Forwarding                                                              
{0}[{1}7{0}] {2}Screen Shot a picture on a phone    {0}[{1}17{0}]{2} Grab wpa_supplicant                                                          
{0}[{1}8{0}] {2}Restart Server                      {0}[{1}18{0}]{2} Show Mac/Inet                                                                
{0}[{1}9{0}] {2}Pull folders from phone to pc       {0}[{1}19{0}]{2} Extract apk from app                                                         
{0}[{1}10{0}] {2}Turn The Device off                {0}[{1}20{0}]{2} Get Battery Status                                                           
 ----------------------------------------------------------------------------------------------------------------------------------------------------                                                                                               
{0}[{1}99{0}] {2}Exit | {0}[{1}0{0}] {2}Clear                                                                                                  
'''.format(Fore.YELLOW, Fore.RESET, Fore.GREEN)

#=============================
#Main
def main():
    page_num = 1
    option = input(Fore.WHITE + "Android-Hackit >> "+Fore.LIGHTYELLOW_EX + "(main_menu) "+Fore.WHITE + "> ")
    if option == '1':
        ...
        ip = input (arrow+" Android-Hackit >> "+Fore.RED + "(connect_phone) "+Fore.WHITE + "> ")
        os.system("adb connect "+ip+":5555")
    
    elif option  == '4':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "Android-Hackit >> "+Fore.RED + "(shell_on_phone) "+Fore.WHITE + "> ")
        os.system("adb -s "+device_name+" shell")

    elif option == '5':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "Android-Hackit >> "+Fore.RED + "(apk_install) "+Fore.WHITE + "> ")
        print (("     "+connect))
        print (("    [{0}+{1}]Enter the apk location.").format(Fore.RED, Fore.WHITE))
        apk_location = input("    "+arrow + "Android-Hackit >> "+Fore.RED + "(apk_install) "+Fore.WHITE + "> ")
        os.system("adb -s  "+device_name+" install "+apk_location)
        print (Fore.GREEN  +  "Apk has been installed.")

    elif option ==  '6':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "Android-Hackit >> "+Fore.RED + "(screen_record) "+Fore.WHITE + "> ")
        print (("     "+connect))
        ...
        place_location = input("    "+arrow + "Android-Hackit >> "+Fore.RED + "(screen_record) "+Fore.WHITE + "> ")
        os.system("adb -s "+device_name+" pull /sdcard/demo.mp4 "+place_location)

    elif option  == '7':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "Android-Hackit >> "+Fore.RED + "(screenshot) "+Fore.WHITE + "> ")
        ...
        place_location = input("    "+arrow + "Android-Hackit >> "+Fore.RED + "(screenshot) "+Fore.WHITE + "> ")
        ...
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "Android-Hackit >> "+Fore.RED + "(file_pull) "+Fore.WHITE + "> ")
        print (("     "+connect))
        print (("    [{0}+{1}]Enter a file location on a device").format(Fore.RED, Fore.WHITE))
        file_location = input("    "+arrow + "Android-Hackit >> "+Fore.RED + "(file_pull) "+Fore.WHITE + "> ")
        print (("        "+connect))
        print (("       [{0}+{1}]Enter where you would like the file to be saved.").format(Fore.RED, Fore.WHITE))
        place_location = input("       "+arrow + "Android-Hackit >> "+Fore.RED + "(file_pull) "+Fore.WHITE + "> ")
        os.system("adb -s "+device_name+" pull "+file_location+" "+place_location)

    elif option == '10':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "Android-Hackit >> "+Fore.RED + "(device_reboot) "+Fore.WHITE + "> ")
        os.system("adb -s "+device_name+ " reboot ")
    
    elif option ==  '11':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "Android-Hackit >> "+Fore.RED + "(app_delete) "+Fore.WHITE + "> ")
        print (("     "+connect))
        print (("    [{0}+{1}]Enter a package name.").format(Fore.RED, Fore.WHITE))
        package_name = input("    "+arrow + "Android-Hackit >> "+Fore.RED + "(app_delete) "+Fore.WHITE + "> ")
        os.system("adb -s "+device_name+" unistall "+package_name)

    elif option == '12':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "Android-Hackit >> "+Fore.RED + "(log) "+Fore.WHITE + "> ")
        os.system('adb -s '+device_name+" logcat ")

    elif option == '13':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "Android-Hackit >> "+Fore.RED + "(sys_info) "+Fore.WHITE + "> ")
        os.system("adb -s "+device_name+" dumpsys")        

    elif option == '14':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "Android-Hackit >> "+Fore.RED + "(package_manager) "+Fore.WHITE + "> ")
        os.system("adb -s " +device_name+ " shell pm list packages -f")
        main()

    elif option == '15':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "Android-Hackit >> "+Fore.RED + "(app_run) "+Fore.WHITE + "> ")
        print (("     "+connect))
        print (("    [{0}+{1}]Enter a package name. They look like this --> com.snapchat.android").format(Fore.RED, Fore.WHITE))
        package_name = input("    "+arrow + "Android-Hackit >> "+Fore.RED + "(app_run) "+Fore.WHITE + "> ")
        os.system("adb -s "+device_name+" shell monkey -p "+package_name+" -v 500")
        main()      

    elif option == '16':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "Android-Hackit >> "+Fore.RED + "(port_forward) "+Fore.WHITE + "> ")
        print (("     "+connect))
        print (("    [{0}+{1}]Enter a port on the device.").format(Fore.RED, Fore.WHITE))
        port_device = input("    "+arrow + "Android-Hackit >> "+Fore.RED + "(port_forward) "+Fore.WHITE + "> ")
        print (("         "+connect))
        print (("        [{0}+{1}]Enter a port to forward it too.").format(Fore.RED, Fore.WHITE))
        forward_port = input("        "+arrow + "Android-Hackit >> "+Fore.RED + "(port_forward) "+Fore.WHITE + "> ")
        ...
        try:
            ...
            device_name = input(arrow + "Android-Hackit >> "+Fore.RED + "(wpa_grab) "+Fore.WHITE + "> ")
            ...
            location = input("    "+arrow + "Android-Hackit >> "+Fore.RED + "(wpa_grab) "+Fore.WHITE + "> ")      
        ...
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "Android-Hackit >> "+Fore.RED + "(mac_inet) "+Fore.WHITE + "> ")
        os.system("adb -s " +device_name+ " shell ip address show wlan0")
        main()

    elif option == '19':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "Android-Hackit >> "+Fore.RED + "(pull_apk) "+Fore.WHITE + "> ")
        print (("     "+connect))
        print (("    [{0}+{1}]Enter a package name. They look like this --> com.snapchat.android").format(Fore.RED, Fore.WHITE))
        package_name = input("    "+arrow + "Android-Hackit >> "+Fore.RED + "(pull_apk) "+Fore.WHITE + "> ")
        ...
        path = input("        "+arrow + "Android-Hackit >> "+Fore.RED + "(pull_apk) "+Fore.WHITE + "> ")
        print (("             "+connect))
        print (("            [{0}+{1}]Enter The location to store the apk: ")  .format(Fore.RED, Fore.WHITE))
        location =   input("            "+arrow + "Android-Hackit >> "+Fore.RED + "(pull_apk) "+Fore.WHITE + "> ")
        os.system("adb -s " +device_name+" pull "+path+" "+location)
        main()

    elif option == '20':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "Android-Hackit >> "+Fore.RED + "(battery) "+Fore.WHITE + "> ")
        os.system("adb -s " +device_name+ " shell dumpsys battery")
        main()

    elif option == '21':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "Android-Hackit >> "+Fore.RED + "(net_stat) "+Fore.WHITE + "> ")
        os.system("adb -s " +device_name+ " shell netstat")
        main()

    elif option == '22':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "Android-Hackit >> "+Fore.RED + "(wifi) "+Fore.WHITE + "> ")
        print (("     "+connect))
        ...
        print (("[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "Android-Hackit >> "+Fore.RED + "(pass_remove) "+Fore.WHITE + "> ")
        ...
        print (("[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "Android-Hackit >> "+Fore.RED + "(keycode) "+Fore.WHITE + "> ")
        print ('''
0 -->  "KEYCODE_UNKNOWN" 
1 -->  "KEYCODE_MENU" 
...
85 -->  "TAG_LAST_KEYCODE"        
        ...
        num = input(arrow + "Android-Hackit >> "+Fore.RED + "(keycode) "+Fore.WHITE + "> ")
        os.system("adb -s "+device_name+" shell input keyevent "+num)

    elif option == '25':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "Android-Hackit >> "+Fore.RED + "(current_activity) "+Fore.WHITE + "> ")
